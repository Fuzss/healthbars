...
public class EntityDisplay {
    ...
    public void draw(GuiGraphics guiGraphics, float scale) {
        if (entity != null) {
            try {
                InventoryScreen.renderEntityInInventoryFollowsMouse(guiGraphics, (int) xOffset, (int) yOffset,
                        (int) xOffset + WIDTH, (int) yOffset + HEIGHT, (int) scale, this.entityScale, -80, -20, entity
                );
